Shader "Unlit/ColorUnlit"
{
   Properties
    ...
    Category
    {
        SubShader
        {
            Tags { "Queue" = "Transparent+8" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False" }
            ...
            Pass
            {
                ...
                Tags {"Queue" = "Transparent+8" "LightMode" = "SceneSelectionPass" }
            ...
            Pass
            {
                ...
                Tags{"Queue" = "Transparent+8" "LightMode" = "Picking" }
            ...
            Pass
            {
                Tags {"Queue" = "Transparent+8" "LightMode"="ForwardBase" }
